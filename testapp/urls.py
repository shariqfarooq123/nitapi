...
urlpatterns = [
   url(r'^subjects/([b,m,p]_[A-Z]{3}_[0-8]_[0-9]{2})/assignments/upload/(.{1,30})/$',views.handle_upload_assignment),
   url(r'^subjects/([b,m,p]_[A-Z]{3}_[0-8]_[0-9]{2})/notes/upload/(.{1,30})/$',views.handle_upload_notes),
